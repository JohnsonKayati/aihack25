...
;
;
function PrescriptionUpload({ prescriptions, onAddPrescription, onRemovePrescription }) {
    ...
    const analyzePhoto = async (file)=>{
        ...
        const mockResults = [
            ...
            },
            {
                ...
                notes: "Dosage mismatch detected. Prescription calls for 10mg but detected 5mg."
            },
            {
...
function MedicationSafetyApp() {
    ...
    const removePrescription = (id)=>{
        ...
        // Also remove any medication logs associated with this prescription
        setMedicationLogs((prev)=>prev.filter((log)=>log.prescriptionId !== id));
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__88b279a9._.js.map